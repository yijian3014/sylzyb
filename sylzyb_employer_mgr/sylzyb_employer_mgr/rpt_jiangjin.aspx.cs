    ...
    public partial class rpt_jiangjin : System.Web.UI.Page
    {
        ...
        protected void btn_cx_Click(object sender, EventArgs e)
        {
          ...
          + " order by [P_BonusDate] ,[WorkerName]";
            ...
            string path = Path.Combine(Server.MapPath(@"\"), "rpt_jiangjin.rdlc");
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = path;
            ReportDataSource rptDataSource1 = new ReportDataSource("DataSet1", SqlDataSource1);
            ReportDataSource rptDataSource2 = new ReportDataSource("DataSet2", SqlDataSource2);
