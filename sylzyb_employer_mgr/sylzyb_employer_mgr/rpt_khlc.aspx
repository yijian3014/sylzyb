<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_khlc.aspx.cs" Inherits="sylzyb_employer_mgr.rpt_khlc" %>
...
<asp:Button ID="btn_ed_time" runat="server" Text="结束时间" OnClick="btn_ed_time_Click" />
                    ...
                    <td>
  <asp:Label ID="Label1" runat="server" Text="流程级别：" ></asp:Label>
                   </td>
                   <td>
                   ...
                   <td>
                       <asp:Label ID="Label4" runat="server" Text="流程类别："></asp:Label>
                   </td>
                   <td>
  ...
  <asp:Calendar ID="cld_ed_date" runat="server" Visible="True" BackColor="White" OnSelectionChanged="Button3_Click"></asp:Calendar>
    ...
    <div style="text-align:center;margin:0 auto;width:950px;float:none; height:760px;overflow:auto;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dzswConnectionString %>" 
            SelectCommand="SELECT * FROM [dzsw].[dbo].[Syl_AppraiseInfo]" OnSelecting="SqlDataSource1_Selecting">
        </asp:SqlDataSource>
